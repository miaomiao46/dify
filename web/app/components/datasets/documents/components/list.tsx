...
import { useDocumentArchive, useDocumentBatchRetryIndex, useDocumentDelete, useDocumentDisable, useDocumentDownloadZip, useToggleAutoUpgrade, useDocumentEnable, useDocumentSummary } from '@/service/knowledge/use-document'
        ...
        <table className={`w-full min-w-[700px] max-w-full border-collapse border-0 text-sm ${s.documentTable}`}>
          <thead className="h-8 border-b border-divider-subtle text-xs font-medium uppercase leading-8 text-text-tertiary">
            <tr>
              ...
              <td className='w-20'>{t('list.table.header.update', { ns: 'datasetDocuments' })}</td>
